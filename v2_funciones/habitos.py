...
def menu():
    ...
    while True:
        ...
        if opcion == "1": añadir_habito(habitos)
        elif opcion == "2": ver_habitos(habitos)
        elif opcion == "3": completar_habito(habitos)
        elif opcion == "4":
